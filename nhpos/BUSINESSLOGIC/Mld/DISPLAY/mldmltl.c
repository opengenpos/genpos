...
* --------------------------------------------------------------------------
* Abstruct:
*      MldMultiTotal() : display items specified minor class "CLASS_MULTITOTAL"
* --------------------------------------------------------------------------
* Update Histories                                                         
...
/*
*===========================================================================
** Format  : VOID   MldMultiTotal(ITEMMULTI *pItem, USHORT usType, USHORT usScroll);
*
...
SHORT  MldMultiTotal(ITEMMULTI *pItem, USHORT usType, USHORT usScroll)
{
    if ((uchMldSystem == MLD_PRECHECK_SYSTEM) ||
        ...
        return (MldPrechkMultiTotal(pItem, usType, usScroll));
