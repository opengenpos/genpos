...
SHORT  MldRptSupConfig(RPTEJ *pData)
{
	...
	TCHAR  aszString[5 * (MLD_SUPER_MODE_CLM_LEN+1)] = {0};           /* buffer for formatted data */
    TCHAR  *pszString;
	...
	NHPOS_ASSERT(usRow < 5);         // Assert that usRow is less than or equal to size of aszString;
