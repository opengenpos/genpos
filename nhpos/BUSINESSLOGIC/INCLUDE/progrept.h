...
*   Mar-08-96 : 00.00.01 : T.Nakahata  : Initial
*
*
** NCR2172 **
*
...
/*#define PROGRPT_VERSION         0x0330   2170 HPUS Release 3.3, V3.3 */
...
#define PROGRPT_PRTCHAR_MINUS   _T('-')
#define PROGRPT_PRTCHAR_DOLLER  _T('$')
#define PROGRPT_PRTCHAR_AT      _T('@')
#define PROGRPT_PRTCHAR_NUM     _T('#')
#define PROGRPT_PRTCHAR_PER     _T('%')
#define PROGRPT_PRTCHAR_COMMA   _T(',')
#define PROGRPT_PRTCHAR_DECIMAL _T('.')
#define PROGRPT_PRTCHAR_ZERO    _T('0')
#define PROGRPT_PRTCHAR_SPACE   _T(' ')
...
#define PROGRPT_DEPTKEY_MDEPTNO 2       /* major department no. (1...10) */
    /* plu */
#define PROGRPT_PLUKEY_PLUNO    1       /* plu no.        (1...9,999,999,999,999)*/
#define PROGRPT_PLUKEY_DEPTNO   2       /* department no. (1...9999) */
...
#define PROGRPT_TTL_LOAN        47  /*  .   .   .   0   .   O   */ /* Saratoga */
#define PROGRPT_TTL_PICKUP      48  /*  .   .   .   0   .   O   */ /* Saratoga */
#define PROGRPT_TTL_FSEXMPT     49  /*  .   .   .   .   .   O   */ /* saratoga */
#define PROGRPT_TTL_FSCREDIT    50  /*  .   .   .   O   .   O   */ /* saratoga */
#define PROGRPT_TTL_COUPON      51  /*  .   .   .   O   .   O   */ /* saratoga */
...
#define PROGRPT_MAX_COLUMN      PROGRPT_MAX_COLUMN_42
                                        /* max column of this version */
#define PROGRPT_MAX_ROW_SPOOL   10      /* max row of spool buffer */

/* --- mark of structure --- */
#define PROGRPT_MARK_FHEAD      _T("REPORT\0\0")
#define PROGRPT_MARK_EOD        _T("EOD\0")
#define PROGRPT_MARK_PTD        _T("PTD\0")
#define PROGRPT_MARK_16CHAR     _T("16C\0")
#define PROGRPT_MARK_40CHAR     _T("40C\0")
#define PROGRPT_MARK_REPORT     _T("\xFF\xFF\xFF\x00")
...
typedef struct {
    TCHAR   auchMark[ PROGRPT_MAX_MARK_FHEAD ];     /* mark of header */
...
typedef struct {
    TCHAR   auchMark[ PROGRPT_MAX_MARK_LEN ];       /* mark of structure */
    ...
    TCHAR   auchReserved[ 4 ];                      /* reserved */
} PROGRPT_EODPTD;


/* --- structure for 16 characters mnemonic --- */
typedef struct {
    TCHAR   auchMnemonic[ PROGRPT_MAX_16CHAR_LEN ]; /* 16 char mnemonic */
} PROGRPT_16CHARREC;
...
typedef struct {
    ...
    TCHAR   auchReserved[ 10 ];                     /* reserved */
} PROGRPT_16CHAR;


/* --- structure for 40 characters mnemonic --- */
typedef struct {
    TCHAR   auchMnemonic[ PROGRPT_MAX_40CHAR_LEN ]; /* 16 char mnemonic */
} PROGRPT_40CHARREC;
...
typedef struct {
    ...
    TCHAR   auchDesc[ PROGRPT_MAX_DESC_LEN ];       /* description */
...
typedef struct {
    ...
    UCHAR   uchReserved1;                           /* */
	UCHAR   auchReserved2[ 2 ];                     /* place holder for auchFormat[ 2 ]*/
