...
*
*               UifAlpha() : Alpha Name entry at cashier operation
* --------------------------------------------------------------------------
* Update Histories                                                         
...
*===========================================================================
*/
UISEQ FARCONST aszSeqRegAlpha[] = {FSC_ALPHA, 0};
...
/*
*===========================================================================
** Synopsis:    SHORT   UifAlpha( KEYMSG *pData )
...
*                 error   not= 0
*
** Description: Alpha Name at cashier operation
*===========================================================================
*/
SHORT   UifAlpha( KEYMSG *pData )
{
    SHORT   sRetStatus;
    SHORT   sStatusSave;
    ...
    switch (pData->uchMsg) {
    case UIM_INIT:
        UieOpenSequence( aszSeqRegAlpha );
        break;                                  
