...
****************************************************************************
*===========================================================================
* Title       : Reg Release Module                         
* Category    : User Interface for Reg, NCR 2170 US Hospitality Application         
* Program Name: UIFRELSE.C
* --------------------------------------------------------------------------
...
*===========================================================================
*/
UISEQ FARCONST aszSeqRegRelease[] = {FSC_FEED_REL, 0};
...
/*
*===========================================================================
** Synopsis:    SHORT UifRelease(KEYMSG *pData)
...
*                 error   not= 0
*
** Description: Reg Release Module
*===========================================================================
*/
SHORT UifRelease(KEYMSG *pData)
{
    SHORT   sRetStatus;
    SHORT   sStatusSave;
    ...
    switch (pData->uchMsg) {
    case UIM_INIT:
        UieOpenSequence(aszSeqRegRelease);      /* open release key sequence */
        break;
    ...
    case UIM_INPUT:
        ...
        if (pData->SEL.INPUT.uchMajor == FSC_FEED_REL) {    /* feed/release ? */
            ...
            /* UifRegData.regother.uchMajorClass = CLASS_UIFREGOTHER;  set release class 
            UifRegData.regother.uchMinorClass = CLASS_UISLIPRELEASE; */
            sRetStatus = ItemOtherSlipRel();            /* Other Module */
