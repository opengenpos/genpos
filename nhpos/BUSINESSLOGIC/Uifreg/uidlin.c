...
****************************************************************************
*===========================================================================
* Title       : Line Number Compulsory Module                         
* Category    : User Interface for Reg, NCR 2170 US Hospitality Application         
* Program Name: UIDLIN.C
* --------------------------------------------------------------------------
...
*
*               UifDiaLineNo() : Line Number Compulsory Dialog
* --------------------------------------------------------------------------
* Update Histories                                                         
...
*===========================================================================
*/
UIMENU FARCONST aChildRegDiaLineNo[] = {{UifDiaLineNoEntry, CID_DIALINENOENTRY},{NULL, 0}};
...
/*
*===========================================================================
** Synopsis:    SHORT UifDiaLineNo(UIFDIADATA *pData)
*     Input:    nothing
...
*               cancel  = -2
*
** Description: Reg Line Number Compulsory
*===========================================================================
*/
SHORT UifDiaLineNo(UIFDIADATA *pData)
{
    KEYMSG  Data;
    ...
    UieInitMenu(aChildRegDiaLineNo);        /* open line number entry */
    for (;;) {
