...
static	PifSemHandle   usApiSem = PIF_SEM_INVALID_HANDLE;	/* semaphore handle */
...
;========================================================================
**/
VOID PLUAPI	PluInitialize(VOID)
{
...
;========================================================================
**/
USHORT PLUAPI PluCreateFile(USHORT usFile, ULONG ulNoOfRec)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluDeleteFile(USHORT usFile)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluClearFile(USHORT usFile)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluSenseFile(USHORT usFile, PMFINFO pFileInfo)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluEnterCritMode(USHORT usFile, USHORT usFunc, USHORT *pusHandle, VOID *pvParam)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluExitCritMode(USHORT usHandle, USHORT usReserve)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluKillCritMode(USHORT usFile, USHORT usReserve)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluAddRecord(USHORT usFile, VOID *pvRec)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI	PluReplaceRecord(USHORT usFile, VOID *pvRec, VOID *pvBuffer, USHORT *pusRet)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluChangeRecord(USHORT usFile, VOID *pvRec, ULONG flChanges, USHORT fsProg, VOID *pvBuffer, USHORT *pusRet)
{
	USHORT	usStat;
	...
	/* --- pass the control to executive routine --- */
	usStat = ExeChangeRecord(usFile, pvRec, flChanges, fsProg, pvBuffer, pusRet);
...
;========================================================================
**/
USHORT PLUAPI PluDeleteRecord(USHORT  usFile, VOID *pItemNumber, USHORT usAdj, 
							USHORT fsProg, VOID *pvBuffer, USHORT *pusRet)
{
	...
	/* --- pass the control to executive routine --- */
	usStat = ExeDeleteRecord(usFile, pItemNumber, usAdj, fsProg, pvBuffer, pusRet);
...
;========================================================================
**/
USHORT PLUAPI PluDeleteReserved(USHORT usHandle)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluResetReserved(USHORT usHandle)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluRewriteReserved(USHORT usHandle, VOID *pvRecord)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluCancelReserved(USHORT usHandle)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluAppendMainte(USHORT usFile, VOID *pvRec)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluPurgeMainte(USHORT usHandle)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluApplyMainte(USHORT usHandle, VOID *pvBuffer, USHORT *pusRet, USHORT *pusApplied)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluApplyMainte2(USHORT usHandle, VOID *pvBuffer, USHORT *pusRet, VOID *pvMainte, USHORT *pusLen)
{
...
;========================================================================
**/
USHORT PLUAPI PluReportMainte(USHORT usHandle, VOID *pvBuffer, ULONG *pulKey, USHORT *pusRet)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluRemoveMainte(USHORT usHandle, ULONG ulKey)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluModifyMainte(USHORT usHandle, ULONG ulKey, VOID *pvRec)
{
	USHORT	usStat;
...
USHORT PLUAPI	PluReadMainte(USHORT usHandle, ULONG ulKey, VOID *pvBuffer, USHORT *pusRet)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluAddMainte(USHORT usHandle, VOID *pvRec, ULONG *pulKey)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluReadRecord(USHORT  usFile,
							PITEMNO pItemNumber,
							USHORT  usAdj,
							VOID    *pvBuffer,
							USHORT  *pusRet)
...
;========================================================================
**/
USHORT PLUAPI PluReserveRecord(USHORT  usHandle, PITEMNO pItemNumber, USHORT  usAdj,
...
;========================================================================
**/
USHORT PLUAPI PluReportRecord(USHORT usHandle, VOID *pvBuffer, USHORT *pusRet)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluUpdateRecord(USHORT usFile, PITEMNO pNumber, USHORT usAdj, PUPDINF pUpdate, VOID *pvBuffer, USHORT *pfsStatus)
{
	USHORT	usStat;
	...
	/* --- pass the control to executive routine --- */
	usStat = ExeUpdateRecord(usFile, pNumber, usAdj, pUpdate, (PUPDINF)NULL, pvBuffer, pfsStatus);
...
;========================================================================
**/
USHORT PLUAPI PluUpdateRecord2(USHORT  usFile, PITEMNO pNumber, USHORT  usAdj,
						PUPDINF pMainInfo, PUPDINF pLinkInfo, VOID *pvBuffer, USHORT *pfsStatus)
{
	...
	/* --- pass the control to executive routine --- */
	usStat = ExeUpdateRecord(usFile, pNumber, usAdj, pMainInfo, pLinkInfo, pvBuffer, pfsStatus);
...
USHORT PLUAPI	PluReadBlock(USHORT usHandle, UCHAR *pucBuffer, ULONG ulSize, ULONG *pulRead)
{
	...
	/* --- pass the control to executive routine --- */
	usStat = ExeReadBlock(usHandle, pucBuffer, ulSize, pulRead);
...
;========================================================================
**/
USHORT PLUAPI	PluSeekBlock(USHORT usHandle, LONG lMoves, USHORT usOrigin, ULONG *pulNewPtr)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluOpenMirror(TCHAR FAR *pszFileName, USHORT *pusMirrorFile)
{
	USHORT	usStat;
...
;========================================================================
**/
USHORT PLUAPI PluOpenMirror2(TCHAR FAR *pszFileName, TCHAR FAR *pszIndexName, USHORT *pusMirrorFile)
{
	USHORT	usStat;
...
USHORT PLUAPI PluCloseMirror(USHORT usMirrorFile)
{
	USHORT	usStat;
...
USHORT PLUAPI PluInformStatus(USHORT usHandle, PLU_STATUS *pPlu_Status)
{
	USHORT	usStat;
