...
* 
*               PrtSupMenuPLU()     : This Function Forms Set Menu      
*                                                                     
* --------------------------------------------------------------------------
* Update Histories                                                         
...
/*
*===========================================================================
** Synopsis:    VOID PrtSupMenuPLU( MAINTMENUPLUTBL *pData )
*               
...
VOID PrtSupMenuPLU( MAINTMENUPLUTBL *pData )
{
    ...
    static const TCHAR FARCONST auchPrtSupMenuPLU3[] = _T("%1u / %-s\t%s-%1u");
    ...
    if (!(pData->uchArrayAddr)) {                       /* Print Parent PLU Case */
        ...
        /* 2172 */
        if ((_tcslen(pData->aszPLUMnemonics) + _tcslen(aszPLUNo)) > PRT_RJCOLUMN-2) {
        ...
        /* 2172 */
        if ((_tcslen(pData->aszPLUMnemonics) + _tcslen(aszPLUNo)) > (PRT_RJCOLUMN-6)) {
