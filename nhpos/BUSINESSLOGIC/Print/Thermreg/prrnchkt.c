...
*===========================================================================
*/
static VOID PrtNewChk_TH( TRANINFORMATION *pTran, ITEMTRANSOPEN  *pItem, SHORT sWidthType )
{
    if ((auchPrtSeatCtl[0] == 0)||(auchPrtSeatCtl[1] == 0)) {

        PrtTHHead(pTran->TranCurQual.usConsNo);   /* --- print thermal header line --- */
...
*===========================================================================
*/
static VOID PrtNewChk_EJ( TRANINFORMATION *pTran, ITEMTRANSOPEN  *pItem, SHORT sWidthType )
{
    if ((auchPrtSeatCtl[0] == 0)||(auchPrtSeatCtl[1] == 0)) {
        ...
        if ((pTran->TranGCFQual.auchFinSeat[1]) && (pItem->uchSeatNo)) {
            ...
            PrtEJTblPerson( pTran->TranGCFQual.usTableNo, pTran->TranGCFQual.usNoPerson, (UCHAR)(auchPrtSeatCtl[0] ? 0 : pItem->uchSeatNo), sWidthType );
        }
...
*===========================================================================
*/
static VOID  PrtNewChk_SP( TRANINFORMATION *pTran, ITEMTRANSOPEN  *pItem, SHORT sWidthType )
{
    ...
    if ((auchPrtSeatCtl[0] == 0)||(auchPrtSeatCtl[1] == 0)) {
        ...
        usSlipLine += PrtSPCustomerName( aszSPPrintBuff[ usSlipLine ], pTran->TranGCFQual.aszName );
