...
*===========================================================================
*/
static VOID  PrtVATSubtotal_TH(TRANINFORMATION  *pTran, ITEMAFFECTION *pItem)
{
/**
...
*===========================================================================
*/
static VOID  PrtVATSubtotal_EJ(TRANINFORMATION  *pTran, ITEMAFFECTION *pItem)
{
...
*===========================================================================
*/
static VOID  PrtVATSubtotal_SP(TRANINFORMATION  *pTran, ITEMAFFECTION *pItem)
{
    TCHAR   aszSPPrintBuff[1][PRT_SPCOLUMN + 1] = { 0 }; /* print data save area */
...
*===========================================================================
*/
static VOID  PrtVATServ_TH(TRANINFORMATION  *pTran, ITEMAFFECTION *pItem)
{
    if ( pTran->TranCurQual.flPrintStatus & CURQUAL_NOT_PRINT_SER ) {
        return;
    }
...
*===========================================================================
*/
static VOID  PrtVATServ_EJ(TRANINFORMATION  *pTran, ITEMAFFECTION *pItem)
{
    if (pTran->TranCurQual.flPrintStatus & CURQUAL_EXCLUDE_SERV){
...
*===========================================================================
*/
static VOID  PrtVATServ_SP(TRANINFORMATION  *pTran, ITEMAFFECTION *pItem)
{
...
*===========================================================================
*/
static VOID  PrtVAT_TH(TRANINFORMATION  *pTran, ITEMAFFECTION *pItem)
{
    USHORT  i, j;   
...
*===========================================================================
*/
static VOID  PrtVAT_EJ(TRANINFORMATION *pTran, ITEMAFFECTION *pItem)
{
    USHORT i,j;
...
*===========================================================================
*/
static VOID  PrtVAT_SP(TRANINFORMATION  *pTran, ITEMAFFECTION *pItem)
{
