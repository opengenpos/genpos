...
*               PrtAddChk2_TH() : prints addcheck (thermal)
*               PrtAddChk2_EJ() : prints addcheck (electric journal)
...
* Oct-29-93 : 02.00.02 : K.You      : del. PrtDflAddChk2()                                   
* Jan-26-95 : 03.00.00 : M.Ozawa    : Recover PrtDflAddChk2()
*===========================================================================
*===========================================================================
* PVCS Entry
* --------------------------------------------------------------------------
...
VOID   PrtAddChk2(TRANINFORMATION  *pTran, ITEMAFFECTION  *pItem)
{
    ...
    if ( fsPrtPrintPort & PRT_RECEIPT ) {  /* thermal print */
        PrtAddChk2_TH(pTran, pItem);
    }

    if ( fsPrtPrintPort & PRT_JOURNAL ) {  /* electric journal */
        PrtAddChk2_EJ(pTran, pItem);
    }
}
