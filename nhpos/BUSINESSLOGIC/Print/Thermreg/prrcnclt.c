...
*      PrtCancel_TH() : transaction cancel ( thermal )
*      PrtCancel_EJ() : transaction cancel ( electic journal )
...
* Oct-29-93 : 02.00.02 : K.You      : del. PrtDflCancel()                                   
...
USHORT PrtDflCancelForm(TRANINFORMATION  *pTran, ITEMMISC  *pItem, TCHAR *puchBuffer)
{
    ...
    _tcsncpy(puchBuffer, aszDflBuff[0], (usLineNo*(PRT_DFL_LINE+1))/ sizeof(TCHAR));
