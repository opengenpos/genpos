...
* Oct-29-93 : 02.00.02 :  K.You     : del. PrtDispDisc()                                   
* Jan-26-95 : 03.00.00 :  M.Ozawa   : recover PrtDispDisc()
...
VOID   PrtItemDisc(TRANINFORMATION  *pTran, ITEMDISC  *pItem)
{
	...
	pItem->aszMnemonic[STD_DEPTPLUNAME_LEN] = 0;  // ensure that the discount mnemonic is zero terminated.
