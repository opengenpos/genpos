...
*    PrtAddChk1_RJ() : print addcheck (receipt & journal)
...
* Mar-03-95 : 03.00.00 : T.Nakahata : Modify for Unique Transaction Number
...
** Return  : none
*
** Synopsis: This function prints add check.
*===========================================================================
*/
VOID   PrtAddChk1(TRANINFORMATION  *pTran, ITEMTRANSOPEN  *pItem)
{
    ...
    if (   (fsPrtPrintPort & PRT_RECEIPT)  /* receipt, journal print */
        ...
        PrtAddChk1_RJ(pTran, sWidthType);
    }
    ...
    if (( ! ( fsPrtPrintPort & PRT_JOURNAL )) &&
        ...
        PrtRJGuest( pTran->TranGCFQual.usGuestNo,
...
/*
*===========================================================================
** Format  : VOID  PrtAddChk1_RJ(TRANINFORMATION  *pTran, SHORT sWidthType);
*
*   Input  : TRANINFORMATION  *pTran     -Transaction Information address
...
** Return  : none
*
** Synopsis: This function prints in add check. (receipt & journal)
*===========================================================================
*/
VOID  PrtAddChk1_RJ(TRANINFORMATION  *pTran, SHORT sWidthType)
{
    ...
    PrtRJTblPerson(usTable, usNoPer, 0, sWidthType);          /* Table no.,  no. of person */
