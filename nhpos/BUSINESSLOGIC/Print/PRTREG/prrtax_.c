...
*      PrtTax()           : print tax
*      PrtDispAffection() : display items specified class "CLASS_ITEMAFFECTION"
*      PrtDflTax()        : display tax
* --------------------------------------------------------------------------
* Update Histories                                                         
*  Date     : Ver.Rev. :   Name     : Description
* Jun-01-92 : 00.00.01 : K.Nakajima :                                    
* Jul-15-93 : 01.00.12 : R.Itoh     : add PrtDispAffection(), PrtDflTax()                                   
* Oct-28-93 : 02.00.02 : K.You      : del. PrtDispAffection(), PrtDflTax()                                   
*           :          :            : del. canada tax feature.                                   
* Jan-17-95 : 03.00.00 : M.Ozawa    : add PrtDispAffection(), PrtDflTax()
* Dec-20-95 : 03.01.00 : M.Ozawa    : recover canada tax feature.
...
VOID   PrtItemAffection(TRANINFORMATION  *pTran, ITEMAFFECTION  *pItem)
{
    ...
    /* V3.3 */
    case CLASS_VAT_SUBTOTAL:                    /* subtotal for VAT */
