...
* --------------------------------------------------------------------------
* Abstract:
*      PrtItemTransOpen() : print items specified class "CLASS_ITEMPRINT"
*      PrtDispTransOpen() : display items specified class "CLASS_ITEMPRINT"
*      PrtDispTransOpenForm() : display items specified class "CLASS_ITEMTRANSOPEN"
* --------------------------------------------------------------------------
* Update Histories                                                         
*  Date     : Ver.Rev. :   Name     : Description
* Jun-04-92 : 00.00.01 : K.Nakajima :                                    
* Jul-20-93 : 00.00.01 : R.Itoh     : add PrtDispTransOpen()                                   
* Oct-28-93 : 02.00.02 : K.You      : del. PrtDispTransOpen()                                   
* Jan-17-95 : 03.00.00 : M.Ozawa    : add PrtDispTransOpen() for display on the fly
