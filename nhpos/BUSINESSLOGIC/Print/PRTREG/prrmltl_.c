...
*      PrtMulTotal_RJ() : print multi check (receipt & journal)
...
* Oct-28-93 : 02.00.02 : K.You      : del. PrtDflMultiTotal()                                   
* Jan-17-95 : 03.00.00 : M.Ozawa    : add PrtDflMultiTotal() for display on the fly
...
/*
*===========================================================================
** Format  : VOID   PrtMulTotal_RJ(ITEMMULTI *pItem);      
*
...
** Return  : none
*
** Synopsis: This function prints multi check grand total. (receipt & journal)
*===========================================================================
*/
VOID   PrtMulTotal_RJ(ITEMMULTI *pItem)
{
    ...
    PrtRJAmtSym(TRN_AMTTL_ADR, pItem->lMI, PRT_DOUBLE);   
}
