...
* Oct-28-93 : 02.00.02 : K.You      : del. PrtDispTotal()                                   
* Jan-17-95 : 03.00.00 : M.Ozawa    : add PrtDispTotal() for display on the fly
* Sep-13-95 : 03.00.08 : T.Nakahata : print unique tran# at Chit Rect (FVT)
* Jun-28-99 : 03.01.09 : M.Ozawa    : display foreign currency total on KDS
