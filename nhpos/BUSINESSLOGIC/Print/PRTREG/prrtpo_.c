...
*               PrtTipsPaidOut_RJ() : print tips paid out ( receipt & journal )
*               PrtTipsPaidOut_VL() : print tips paid out ( validation )
...
* Oct-28-93 : 02.00.02 : K.You      : del. PrtDflTipsPaidOut()                                   
* Apr-08-94 : 00.00.04 : K.You      : add validation slip print feature.(mod. PrtTipsPaidOut)
* Jan-17-95 : 03.00.00 : M.Ozawa    : add PrtDflTipsPaidOut() for display on the fly
...
/*
*===========================================================================
** Format  : VOID PrtTipsPaidOut_RJ(ITEMMISC *pItem);      
*
...
** Return  : none
*            
** Synopsis: This function prints tips paid out. (receipt & journal)
*===========================================================================
*/
VOID  PrtTipsPaidOut_RJ(ITEMMISC *pItem)
{
    ...
    PrtRJWaiter(pItem->ulID);                    /* waiter */

    PrtRJAmtMnem(TRN_TIPPO_ADR, pItem->lAmount); /* tips paid out line */

}

/*
*===========================================================================
** Format  : VOID PrtTipsPaidOut_VL(TRANINFORMATION *pTran, ITEMMISC *pItem);      
*
*   Input  : TRANINFORMATION  *pTran     -Transaction Information address
*            ITEMMISC         *pItem     -Item Data address
*   Output : none
...
** Return  : none
*            
** Synopsis: This function prints tips paid out. (validation)
*===========================================================================
*/
VOID  PrtTipsPaidOut_VL(TRANINFORMATION *pTran, ITEMMISC *pItem)
{
    ...
    if ( usPrtVLColumn == PRT_VL_24 ) {
        ...
        PrtVLTipPaidOut(pItem->ulID, pItem->lAmount); /* waiter & amount line */
        PrtVLTrail(pTran);                      /* send trailer line */
    }

    /* -- in case of 21 char printer -- */
    if ( usPrtVLColumn == PRT_VL_21 ) {
        PrtVSTipsPO(pTran, pItem);
    }
