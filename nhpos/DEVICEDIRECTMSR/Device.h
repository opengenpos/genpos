...
public:
	...
	enum {	EVENT_MSR_DATA     = 0x10000,	// scale event
...
protected:
	...
	DWORD	OnIoControl(HANDLE hDevice,
				...
				DWORD dwOutBufferSize,
				LPDWORD lpBytesReturned);
	DWORD	OnIoControlReadTracks(HANDLE hDevice,
				DWORD dwIoControlCode,
				LPVOID lpInBuffer,
				DWORD dwInBufferSize,
				LPVOID lpOutBuffer,
...
protected:
	...
	HANDLE				m_hDevice;			// scale data event
	CPacket*			m_pDevice;			// ptr. to scale packet
	CDevice*			m_pUser;
