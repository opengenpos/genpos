...
typedef struct  {          
        ...
        UCHAR  aszMnemonics[PARA_TRANSMNEMO_LEN+1];      /* Transaction Mnemonics Data */
...
typedef struct  {
        ...
        UCHAR  aszPLUNumber[PLU_MAX_DIGIT+1]; /* PLU Number  + 1*/
}PLUNO;
...
typedef struct  {
        ...
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        UCHAR  aszMnemonics[PARA_LEADTHRU_LEN+1]; /* Mnemonics for LeadThru */
...
typedef struct  {          
        ...
        UCHAR  uchMajorFSCData;       /* Major FSC Data */
        UCHAR  uchMinorFSCData;       /* Minor FSC Data */
        USHORT usPLUNumber;           /* PLU Item Number */        
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        UCHAR  aszMnemonics[PARA_LEADTHRU_LEN+1]; /* Mnemonics for LeadThru */
        USHORT usPrintControl;        /* Print Control */
}PARAPLUNOMENU;                 
...
typedef struct  {
    ...
    UCHAR  aszMnemonics[PARA_SOFTCHK_LEN+1];    /* Char. 42 Mnemonics Data */
    UCHAR  uchStatus;                           /* 0=with data, 1=without data */
    USHORT usPrintControl;                      /* Print Control */
}PARASOFTCHK;        
...
typedef struct  {
        ...
        UCHAR  uchMinorClass;         /* Minor Class Data Definition */
        UCHAR  uchAddress;            /* Address */
        UCHAR  aszProSales[PARA_PROMOTION_LEN+1];      /* Promotion Sales Header */
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        USHORT usPrintControl;        /* Print Control */
}PARAPROMOTION;
...
typedef struct  {
        ...
        UCHAR   aszLeadMnemonics[PARA_LEADTHRU_LEN+1];  /* Lead Through Mnemonics */
...
typedef struct  {
        ...
        UCHAR  uchHALO;                             /* HALO */
        UCHAR  aszMnemonic[PARA_DEPT_LEN+1];        /* DEPT Name */
...
typedef struct  {
        ...
        UCHAR  uchCPNNumber;                        /* Combination Coupon Number */
        UCHAR  uchCPNStatus[MAX_CPNSTS_SIZE];       /* Status */
        ULONG  ulCPNAmount;                         /* Amount */
        UCHAR  aszMnemonic[PARA_CPN_LEN+1];         /* Coupon Name */
        UCHAR  auchCPNTarget[MAX_CPNTARGET_SIZE][PLU_MAX_DIGIT];    /* PLU Number, 2172 */
...
typedef struct  {
        ...
        UCHAR  auchPLUNumber[PLU_MAX_DIGIT+1+1];    /* PLU Number w/ scan code, 2172 */
        ...
        UCHAR  aszMnemonics[PARA_PLU_LEN+1];        /* PLU Name */
...
typedef struct  {
        UCHAR  uchMajorClass;                                           /* Major Class Data Definition */                            
        UCHAR  uchMinorClass;                                           /* Minor Class Data Definition */                                  
        UCHAR  uchAddr;                                                 /* Field Address of PPI */
        UCHAR  uchPPINumber;                                            /* PPI Number */
        UCHAR  uchPPILength;
...
typedef struct  {
        ...
        UCHAR  aszMDCString[4+1];      /* MDC Strings Data */ 
        UCHAR  uchStatus;              /* 0=with data, 1=without data */
        USHORT usPrintControl;         /* Print Control */
}PARAMDC;
...
typedef struct  {
        ...
        UCHAR  uchMajorFSCData;       /* Major FSC Data */
        UCHAR  uchMinorFSCData;       /* Minor FSC Data */
        USHORT usPluNo;               /* Plu No. Data R3.1 */
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        USHORT usPrintControl;        /* Print Control */
}PARAFSC;
#endif
...
typedef struct  {
        ...
        UCHAR  aszMDCString[4 + 1];   /* MDC String Data */
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        USHORT usPrintControl;        /* Print Control */
}PARAACTCODESEC;
...
typedef struct  {
        ...
        UCHAR  aszMnemonics[PARA_LEADTHRU_LEN+1];      /* Lead Through Data */
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        USHORT usPrintControl;        /* Print Control */
}PARALEADTHRU;
...
typedef struct  {
        ...
        UCHAR  aszMnemonics[PARA_REPORTNAME_LEN+1];      /* Report Name Data */
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        USHORT usPrintControl;        /* Print Control */
}PARAREPORTNAME;
...
typedef struct  {
        ...
        UCHAR  aszMnemonics[PARA_SPEMNEMO_LEN+1];      /* Special Mnemonics Data */
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        USHORT usPrintControl;        /* Print Control */
}PARASPEMNEMO;
...
typedef struct  {
        ...
        UCHAR  uchMinorClass;         /* Minor Class Data Definition */                                  
        UCHAR  uchAddress;            /* Address of Transaction Mnemonics */
        UCHAR  aszMnemonics[PARA_PCIF_LEN+1];      /* PC Password Mnemonics Data */
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        USHORT usPrintControl;        /* Print Control */
}PARAPCIF;
...
typedef struct  {
        ...
        UCHAR  aszMnemonics[PARA_ADJMNEMO_LEN+1];      /* Adjective Mnemonics Data */
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        USHORT usPrintControl;        /* Print Control */
}PARAADJMNEMO;
...
typedef struct  {
        ...
        UCHAR  aszMnemonics[PARA_PRTMODI_LEN+1];      /* Print Modifier Mnemonics Data */
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        USHORT usPrintControl;        /* Print Control */
}PARAPRTMODI;
...
typedef struct  {
        ...
        UCHAR  aszMnemonics[PARA_MAJORDEPT_LEN+1];      /* Major DEPT Mnemonics Data */
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        USHORT usPrintControl;        /* Print Control */
}PARAMAJORDEPT;
...
typedef struct  {
        ...
        UCHAR  uchMinorClass;         /* Minor Class Data Definition */
        UCHAR  uchAddress;            /* Address of 24 Char. Mnemonics */
        UCHAR  aszMnemonics[PARA_CHAR24_LEN+1];      /* Char. 24 Mnemonics Data */
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        USHORT usPrintControl;        /* Print Control */
}PARACHAR24;
...
typedef struct  {
        ...
        UCHAR  aszTtlKeyMDCString[4+1]; /* MDC Strings Data */
        UCHAR  uchStatus;               /* 0=with data, 1=without data */
        USHORT usPrintControl;          /* Print Control */
}PARATTLKEYCTL;
...
typedef struct  {
        ...
        UCHAR  uchStatus;                       /* 0=with data, 1=without data */
        UCHAR  aszLeadMnemonics[PARA_LEADTHRU_LEN+1]; /* Mnemonics */
        USHORT usPrintControl;                  /* Print Control */
}PARATONECTL;
...
typedef struct  {          
        ...
        UCHAR  aszMnemonics[PARA_LEADTHRU_LEN+1];      /* Leadthrouh,Special Mnemonics Data */
        UCHAR  uchStatus;             /* 0=with data, 1=without data */
        USHORT usPrintControl;        /* Print Control */
}PARATARE;                 
...
typedef struct  {
        UCHAR  uchMajorClass;         /* Major Class Data Definition */                             
        UCHAR  uchMinorClass;         /* Minor Class Data Definition */                                  
        UCHAR  auchMnemo[MAX_TALLY_MNEMO];           /* Mnemonic */
...
typedef struct  {
        ...
        UCHAR  uchMinorClass;         /* Minor Class Data Definition */                                  
        UCHAR  uchAddress;            /* Address of Adjective Mnemonics */
        UCHAR  aszMnemonics[MAX_HOTELID_SIZE+1];  /* Mnemonics
...
typedef struct  {
        UCHAR auchHotelId[PARA_HOTELID_LEN];    /* Hotel Id save Area       */
        UCHAR auchSld[PARA_SLD_LEN];            /* SLD Id save area         */
        UCHAR auchProductId[PARA_PDT_LEN];      /* Product Id save area     */
        UCHAR auchTend[STD_TENDER_MAX];                     /* Tender 1 to 11 EPT Action code */
...
typedef struct  {
    ...
    UCHAR  uchMinorClass;                       /* Minor Class Data Definition */
    UCHAR  uchAddress;                          /* Address of Mnemonics */
    UCHAR  aszMnemonics[PARA_MLDMNEMO_LEN+1];   /* Char. 32 Mnemonics Data */
    UCHAR  uchStatus;                           /* 0=with data, 1=without data */
    USHORT usPrintControl;                      /* Print Control */
}PARAMLDMNEMO;
...
typedef struct {
    ...
    UCHAR  aszInputData[MAX_KDSIP_INPUT_LEN];   /* input buffer */
    UCHAR  uchStatus;                           /* 0=with data, 1=without data */
    USHORT usPrintControl;                      /* Print Control */
}PARAKDSIP;
