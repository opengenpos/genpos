...
:   Category           : SUPER & PROGRAM MODE,ECR              :
...
#define     CLASS_RPTJCSUMMARY  217     /* JOB COST SUMMARY FOR EMPLOYEE SR07 */
#define     CLASS_RPTJCSUMMARYTITLES  218     /* JOB COST SUMMARY TITLES SR07 */
#define     CLASS_RPTJCSUMMARYTOTALS  219     /* JOB COST SUMMARY TOTALS SR07 */
...
#define CLASS_PARATTLKEYORDERDEC	254
...
#define MAX_FSC_TBL            11    /* Function Key Table *///RPH 12-2-3
#define MAX_FSC_NO            300    /* Function Key 165->300 JHHJ Database Changees 3-17-04*/
...
#define MAX_LEAD_NO           220    /* Max number of Lead Through mnemonics, CLASS_PARALEADTHRU */
#define MAX_REPO_NO            32    /* Report Name, CLASS_PARAREPORTNAME */
...
#define MAX_CH24_NO            40    /* 24 Characters, 2172 */
#define MAX_PAGE_SIZE          23    /* Control Menu Page, */ //RPH 12-2-3 TOUCHSCREEN
...
#define MAX_DISPPARA_TENDER    STD_TENDER_MAX    /* JHHJ 3-16-04 Max Tender Key Data of Beverage Dispenser */
...
#define MDC_RETURNS_RTN2_ADR  518     /* Returns key (option 2 of void), Amtrak */
#define MDC_RETURNS_RTN3_ADR  519     /* Returns key (option 3 of void), Amtrak */
...
#define FSC_PLU_MAX         165      /* Keyed PLU for Micromotion,  R3.1 */
...
#define FSC_TOTAL_MAX         9      /* Total Key */
...
#define FSC_CPN_MAX         300      /* Coupon Key */
...
#define SPNO_ADR_MAX            MAX_SUPLEVEL_SIZE    /* Max Address */
...
#define SLIP_ADR_MAX            MAX_SLIP_SIZE    /* Max Address */
...
#define TRN_GIFT_RECEIPT_ADR  197		// Gift Receipt for receipt JHHJ
...
#define SPC_EC_ADR             40        /* E/C,    DTREE#2 */
...
#define PLUPG_PAGE10_ADR		10			//Menu Page 10 RPH 12-2-3 TOUCHSCREEN
#define PLUPG_PAGE11_ADR		11			//Menu Page 11 RPH 12-2-3 TOUCHSCREEN
...
#define CTLPG_ADJ_PAGE1_ADR    11        /* Adjective Menu Page 1, 2172 */
#define CTLPG_ADJ_PAGE2_ADR    12        /* Adjective Menu Page 2, 2172 */
#define CTLPG_ADJ_PAGE3_ADR    13        /* Adjective Menu Page 3, 2172 */
#define CTLPG_ADJ_PAGE4_ADR    14        /* Adjective Menu Page 4, 2172 */
#define CTLPG_ADJ_PAGE5_ADR    15        /* Adjective Menu Page 5, 2172 */
#define CTLPG_ADJ_PAGE6_ADR    16        /* Adjective Menu Page 6, 2172 */
#define CTLPG_ADJ_PAGE7_ADR    17        /* Adjective Menu Page 7, 2172 */
#define CTLPG_ADJ_PAGE8_ADR    18        /* Adjective Menu Page 8, 2172 */
#define CTLPG_ADJ_PAGE9_ADR    19        /* Adjective Menu Page 9, 2172 */
...
#define RATE_ITMDISC3_ADR		21
#define RATE_ITMDSIC4_ADR		22
...
#define CNV_ADR_MAX              MAX_FC_SIZE        /* Max Address */
...
#define PARA_TRANSMNEMO_LEN     20       /* ParaTransMnemo Database Changes JHHJ*/
...
#define PARA_MAJORDEPT_LEN      20       /* ParaMajorDEPT Database Changes JHHJ*/
...
#define PLU_BONUSTL_MAX         STD_NO_BONUS_TTL	/* Changed 8->100 JHHJ*/
...
#define LCD_AC102_ADR         213		// AC 102, Mnemoonic, CID_AC102FUNCTION, AC_STORE_FORWARD, Status
...
#define LCD_CAS_ADDR11_ADR	  212		// AC 20
...
#define LCD_ADR_MAX           240       /* Max Address, saratoga */
