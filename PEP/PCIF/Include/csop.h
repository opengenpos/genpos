...
/*#define    OP_MAX_WORK_BUFFER     512*/
/****
#define    OP_MAX_WORK_BUFFER    1000
****/
...
#define    OP_MAX_PPI_NO          300   /* Promotional Pricing Item, ESMITH*/
//#define    OP_MAX_PPI_NO          100   /* Promotional Pricing Item, R3.1 */
...
typedef  struct {
    ...
    UCHAR   auchCouponTarget[OP_CPN_TARGET_SIZE][OP_PLU_LEN];
...
typedef    struct {
    /* USHORT  usPluNo; */
    UCHAR   auchPluNo[OP_PLU_LEN];      /* for temporary */
    UCHAR   uchPluAdj;
    ULONG   ulCounter;
...
typedef    struct {
    ...
    UCHAR    auchPluNo[OP_PLU_LEN];     /* for temporary */
    UCHAR    uchPluAdj;
    UCHAR    uchPluName[OP_PLU_NAME_SIZE];
} PLU_PARA;
