...
#define MAINT_DATA_INPUT2     0x80   /* Status Flag (data already inputted) 2172 */
...
#define MAINT_RECEIPT_CTL     0x01   /* Set Receipt */
#define MAINT_JOURNAL_CTL     0x02   /* Set Journal */
...
#define CLASS_MAINTTENDER1                1   /* Tender 1(Cash) */
#define CLASS_MAINTTENDER2                2   /* Tender 2(Food) */
#define CLASS_MAINTTENDER3                3   /* Tender 3(Charge) */
#define CLASS_MAINTTENDER4                4   /* Tender 4(Misc1) */
#define CLASS_MAINTTENDER5                5   /* Tender 5(Misc2) */
#define CLASS_MAINTTENDER6                6   /* Tender 6(Misc3) */
#define CLASS_MAINTTENDER7                7   /* Tender 7(Misc4) */
#define CLASS_MAINTTENDER8                8   /* Tender 8(Misc5) */
#define CLASS_MAINTTENDER9                9   /* Tender 9(Misc6) */
#define CLASS_MAINTTENDER10              10   /* Tender 10(Misc7) */
#define CLASS_MAINTTENDER11              11   /* Tender 11(Misc8) */
#define CLASS_MAINTFOREIGN1              21   /* F/C Tender 1 */
#define CLASS_MAINTFOREIGN2              22   /* F/C Tender 2 */
#define CLASS_MAINTFOREIGN3              23   /* F/C Tender 3 (R2.0) */
#define CLASS_MAINTFOREIGN4              24   /* F/C Tender 4 (R2.0) */
#define CLASS_MAINTFOREIGN5              25   /* F/C Tender 5 (R2.0) */
#define CLASS_MAINTFOREIGN6              26   /* F/C Tender 6 (R2.0) */
#define CLASS_MAINTFOREIGN7              27   /* F/C Tender 7 (R2.0) */
#define CLASS_MAINTFOREIGN8              28   /* F/C Tender 8 (R2.0) */
...
#define CLASS_PARACASHIERNO_DATA5    5   /* Operator Status #5 */
...
#define CAS_FIELD_MAX           10     /* Max Field */
...
#define MAINT_CASH_MAX          999                 /* Cashier No. Max Value */           
#define MAINT_WAIT_MAX          999                 /* Waiter No. Max Value */           
#define MAINT_ETK_MAX    999999999L                 /* Employee No. Max Value R3.1 */
#define MAINT_GC_MAX           9999                 /* Geust Check No. Max Value */
#define MAINT_RPT_GC_MAX      19999                 /* Geust Check No. Max Value, R3.3 */
#define MAINT_DISC_MAX          100                 /* Discount Rate Max Value */
#define MAINT_MAXFEED_MAX        99                 /* Max Feed Line # of GC for Slip Printer */
#define MAINT_MAXLINE_MAX        31                 /* Max Line up to 1st Print Line */
#define MAINT_VALIDATION_MIN      0                 /* Minimum Number of Times to Allow Validation SR47 */
#define MAINT_VALIDATION_MAX      9                 /* Max Number of Times to Allow Validation SR47*/
#define MAINT_EJLEN_MIN          50                 /* Minimum electoric journal line for 1 page */
#define MAINT_EJLEN_MAX         150                 /* Max electoric journal line for 1 page */
#define MAINT_REVEJLEN_MAX       99                 /* Max electoric journal line for Reverse func. */
#define MAINT_NEARFULL_MAX       99                 /* Max near full % for electoric journal file */
...
#define MAINT_TLTY_MAX           78                 /* Total Key Type & Index Max Value */
#define MAINT_TLTY_MIN           10                 /* Total Key Type & Index Min Value */
...
#define MAINT_SUPERNO_MIN       800                 /* Minimum Supervisor Number */  
#define MAINT_SUPERNO_MAX       899                 /* Max Supervisor Number */  
#define MAINT_TAXEXEMPT_MAX   65535                 /* Max Tax Exempt Limit Value */
#define MAINT_TAXTBL_MUSTSIZE     8
#define MAINT_BONUSTL_MAX         STD_NO_BONUS_TTL	/* Max Bonus changed 8->100 JHHJ*/
...
#define MAINT_TERM_MAX           16                 /* Max Terminal No. for Shared Printer */
...
#define MAINT_TEND_MAX           11                 /* Max Data for Tender Key Parameter, V3.3 */
...
#define MAINT_TERMINAL_MAX       16                 /* MAX Allowed Terminal Number */
...
#define MAINT_CSTR_NO_MAX          400     /* Control Strings Number Max Value */
#define MAINT_CSTR_ADR_MAX         200     /* Control Strings Address Max Value */
...
#define MAINT_NUMBER_OF_CASHIER_NAME  20          /* number of cashier name */
#define MAINT_NUMBER_OF_CASHIER_STATUS 2          /* Width of cashier status (CHAR) */
...
#define MAINT_PPI_NO_MAX           300     /* PPI Code Max Value */
...
typedef struct {
    ...
    UCHAR   uchPrgSupNo;            /* Program, Super Number */
...
typedef struct {
        ...
        UCHAR  uchComStatus;          /* Communication Status */
        USHORT usPrtControl;          /* Print Control */
}MAINTBCAS;    
...
typedef struct {              
        ...
        UCHAR       uchJobCode;      
        USHORT      usTimeInTime;    
        USHORT      usTimeInMinute;  
        USHORT      usTimeOutTime;   
        USHORT      usTimeOutMinute; 
        WCHAR       aszTransMnemo[PARA_TRANSMNEMO_LEN+1]; /* Transaction Mnemonics */
        WCHAR       aszMnemonics[PARA_LEADTHRU_LEN+1];   /* Mnemonics */
...
typedef struct{
    USHORT  usCashierNo;
    UCHAR   fbCashierStatus[MAINT_NUMBER_OF_CASHIER_STATUS];
    USHORT  usGstCheckStartNo;
    USHORT  usGstCheckEndNo;
    UCHAR   uchChgTipRate;
    UCHAR   uchTeamNo;
    UCHAR   uchTerminal;
    WCHAR   auchCashierName[MAINT_NUMBER_OF_CASHIER_NAME];
    UCHAR   uchCashierSecret;
    USHORT  usUniqueAddress;
    UCHAR   fbCashierOption;
}MATCASIF;
...
typedef struct {
    ...
    MATCASIF  CashierIf;        /* Cashier I/F Structure */
    WCHAR  aszMnemonics[PARA_LEADTHRU_LEN+1];   /* Mnemonics */
    UCHAR  uchStatus;       /* 0=with data, 1=without data */
    USHORT usPrintControl;      /* Print Control */
}MAINTCASHIERIF;
...
typedef struct {
    ...
    WCHAR   aszMnemonics[MAINT_NUMBER_OF_CASHIER_NAME+1]; /* Mnemonics */
    USHORT  usConsCount;           /* consecutive counter */
...
typedef struct {
        ...
        WCHAR  auchCashierName[MAINT_NUMBER_OF_CASHIER_NAME+1]; /* Cashier Mnemonic] */
...
VOID MaintCurrencyMDCRead( UCHAR *puchMDCData, UCHAR uchAddress );
...
VOID  MaintSetCasDispData( UCHAR uchFieldAddr );        /* matcas.c */
...
SHORT MaintFSCMnem(VOID);                           /* Saratoga */
SHORT MaintFSCMnemClear(VOID);                      /* Saratoga */
VOID  MaintFSCDispPlu(MAINTFSCPLU *pPlu, SHORT sNum);   /* Saratoga */
...
VOID  MaintPCIFGetCommand( UCHAR *paszCommand );
...
SHORT MaintLoadAll( VOID );                             /* MATLALL.C */
SHORT MaintLoadSup( VOID );                             /* MATLSUP.C */

VOID  MaintIncreSpcCo(UCHAR uchCoAddress);
VOID  MaintMakeAbortKey(VOID);
VOID  MaintHeaderCtl(UCHAR uchPrgSupNo, UCHAR uchRptAdr1);
VOID  MaintFeed(VOID);
...
SHORT MaintChkSup(ULONG usSuperNumber);                            /* Check Supervisor No. */
...
SHORT MaintChkBinary(UCHAR auchChkString[], UCHAR uchChkDigit);      /* Check Binary Data */
UCHAR MaintAtoStatus(UCHAR auchString[]);
...
SHORT MaintGetPLUNo(UCHAR uchMinorFSCData, UCHAR *paszPLUNumber, UCHAR *puchModStat);   /* MATCOM.C */  
...
SHORT MaintPPIRead( MAINTPPI *pData );                /* A/C 71 */
...
VOID  MaintSPHeadTrailSet(MAINTSPHEADER *pData, USHORT usNumber, UCHAR *pszMnemo);
VOID  MaintSPHeaderCtl(MAINTSPHEADER *pData);
VOID  MaintSPTrailCtl( MAINTSPHEADER *pData);
VOID  MaintTrnOpen(UCHAR uchMinorClass, MAINTLOANPICKUP *pData);     /* Saratoga */
...
VOID  MaintAllPickupAmountRead(USHORT usCashierNumber );
...
SHORT MaintFCRateCalc1(UCHAR uchMDCData, LONG *plModAmount, 
                       LONG lAmount, ULONG ulRate, UCHAR uchType);
SHORT MaintFCRateCalc2(UCHAR uchMDCData, LONG *plModAmount, 
                       LONG lAmount, ULONG ulRate, UCHAR uchType);
VOID  MaintFCRateCalcByEuroB(LONG *plForiegn, LONG lMI, 
                   ULONG ulCurrency, UCHAR uchType, USHORT usConvType, UCHAR uchMDCData);
