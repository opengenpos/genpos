...
#define PLU_STATUS_LEN              10          /* ### ADD 2172 Rel1.0      *//* ### MOD Saratoga FamilyCode (12 --> 10)(052900) */
...
typedef struct _RECPLUR22 {                 /* format of PLU record         */
    ...
    UCHAR   uchPriceMulWeight;                  /* price multiple / weight  */
    WCHAR   aucMnemonic[PLU_MNEMONIC_LEN_22];   /* mnemonics (16bytes)      */
...
#define PLU_BEFORE_STATUS_LEN       102          /* 52 *//* auchPluNumber[13] +
                                                    uchAdjective +
                                                    usDeptNumber +
                                                    ulUnitPrice[5] +
                                                    uchPriceMulWeight +
