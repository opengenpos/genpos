...
// definitions to handle MBCS and Unicode strings for multi-lingual
#if !defined(UWCHAR)
...
*   PARAMETER - MAJOR DATA CLASS DEFINE
	   ...
	   in the PCIF 3rd Party Toolkit version of paraequ.h and in the NHPOS
...
#define CLASS_PARATRANSHALO     118     /* TRANSACTION HALO */
#define CLASS_PARAHOURLYTIME    119     /* HOURLY ACTIVITY TIME */
#define CLASS_PARASLIPFEEDCTL   120     /* SLIP PRINTER FEED CONTROL */
#define CLASS_PARATRANSMNEMO    121     /* TRANSACTION MNEMONICS */
#define CLASS_PARALEADTHRU      122     /* LEAD THROUGH TABLE */
#define CLASS_PARAREPORTNAME    123     /* REPORT NAME */
#define CLASS_PARASPECIALMNEMO  124     /* SPECIAL MNEMONICS */
...
#define CLASS_PARAADJMNEMO      128     /* ADJECTIVE MNEMONICS */
#define CLASS_PARAPRTMODI       129     /* PRINT MODIFIER MNEMONICS */
#define CLASS_PARAMAJORDEPT     130     /* REPORT CODE MNEMONICS */
#define CLASS_PARACHAR24        131     /* 24 CHARACTERS MNEMONICS */
...
#define     CLASS_RPTPROGRAM    216     /* PROGRAMABLE REPORT (REPORT,PRINT) */
    ...
    /* ----- New TOTAL Major Class Functions (Release 3.1) ----- */
...
#define CLASS_TTLINDFIN         221     /* INDIVIDUAL FINANCIAL (TOTAL,REPORT) */
    ...
    /* ----- New MAINTENANCE Major Class Functions (Release 3.1) ----- */
...
#define CLASS_PARAMISCPARA      236     /* SET MISC LIMITATION TABLE (S) *//* ### ADD Saratoga (051900) */
...
#define CLASS_FILEVERSION_INFO  242		//used for sending version information to NHPOS 10-22-04 JHHJ
...
#define CLASS_PARAAUTOCPN		252		/* AUTO COMBINATIONAL COUPONS	  */ //RLZ
#define CLASS_PARACOLORPALETTE	253		/* COLOR PALETTE CODES - CSMALL		*/
#define CLASS_PARATTLKEYORDERDEC 254	/* Order Dec Total Key JHHJ*/
#define CLASS_PARACASHABASSIGNJOB	255		// CASHIER A/B KEYS ASSIGNMENT Job ranges (smurray)
...
/* for Set PLU No. On Menu Page, 2172  */
...
/* for Set Dept No. On Menu Page, 2172  */
...
#define MAX_PLUKEY_SIZE      1485    /* Keyed PLU Key */
...
/* #define MAX_CH44_NO              4 */   /* 44 Characters */
#define MAX_PROMO_NO            3    /* Line for Promotion Message */
#define MAX_HGV10_PROMO_NO      3    /* Line for Promotion Message used in UNINIRAM_HGV10*/
...
//#define MAX_MDC_SIZE          200    /* MDC Data for 1byte Data, 2172 */
#define MAX_MDC_SIZE          600    /* MDC Data for 1byte Data, 2172 */

#define MAX_FSC_TBL_HGV10             9    /* Function Key Table */
#define MAX_FSC_TBL            11    /* Function Key Table *///JHHJ 12-02-03
#define MAX_FSC_NO            300    /* Function Key 165->300 JHHJ Database Change 3-17-04*/
#define MAX_FSC_DATA            2    /* Major FSC Data/Minor FSC Data */
#define MAX_SUPLEVEL_SIZE      22    /* Supervisor Level */
#define MAX_ACSEC_SIZE        127    /* Action Code Security for Supervisor */
...
#define MAX_TRANSM_NO         400    /* Transaction Memonics, 2172 */
//#define MAX_TRANSM_NO         200    /* Transaction Memonics, 2172 */
#define MAX_LEAD_NO           220    /* Max number of Lead Through mnemonics */
#define MAX_REPO_NO            32    /* Report Name */
#define MAX_SPEM_NO            75    /* Special Mnemonics, CLASS_PARASPECIALMNEMO */
...
#define MAX_MDEPT_NO           30    /* Major Department Mnemonics */
#define MAX_CH24_NO            40    /* 24 Characters mnemonics, CLASS_PARACHAR24 */

#define MAX_PAGE_SIZE_HGV10		19	 /*Old file size*/
#define MAX_PAGE_SIZE          23    /* Control Menu Page, 2172 */
#define MAX_DEST_SIZE           8    /* Destination Kitchen Printer */
#define MAX_FLXMEM_SIZE    (13+1)    /* Flexible Memory Assignment, with MLD File */
#define MAX_STOREG_SIZE         2    /* Store/Register No. */

#define MAX_KEYTYPE_SIZE        17    /* Total Keys are in need of type assign */
#define MAX_TTLKEY_NO           STD_TOTAL_MAX    /* The number of Total Key */
...
#define MAX_DISPPARA_TENDER    11    /* Max Tender Key Data of Beverage Dispenser */
#define MAX_DISPPARA_TOTAL     19    /* Max Total Key Data of Beverage Dispenser */
#define MAX_TEND_NO            STD_TENDER_MAX    /* JHHJ 3-16-04 Key for Tender Para, V3.3 */

#define MAX_PRESETAMOUNT_SIZE   4    /* Max Size of Preset Amount Cash Tender */
...
#define MAX_FXDRIVE_TERM_SIZE  16    /* Max Terminal# of FLEXIBLE DRIVE THROUGH/MULTI STORE RECALL */
#define MAX_PARACSTR_SIZE     200    /* Max One Control String Size */
...
#define MAX_LABORCOST_SIZE    100    /* Max no. of labor cost value */
#define MAX_DISPPARA_SIZE     259    /* Max no. of beverage dispenser parameter */

/*** NCR2172 ***/
#define MAX_MLDMNEMO_SIZE     240    /* Max no. of multi-line display parameter */
#define MAX_RSNMNEMO_SIZE     400    /* Max no. of Reason Code mnemonics */

/*#define MAX_KDSIP_SIZE			6*/	/* KDS IP Address, 2172 */
...
#define MAX_REST_SIZE           6    /* PLU Sales Restriction Table   */
#define MAX_AGE_SIZE            3    /* Boundary age */
/*#define MAX_DEPTKEY_SIZE      1485 */   /* Keyed PLU Key */
#define MAX_DEPTKEY_SIZE      450    /* Keyed Dept Key, 2172 */
#define MAX_MISC_SIZE         STD_MAX_MISC_SIZE    /* Misc. Parameter */

#define MAX_TERMINALINFO_SIZE  16    /* Max number of terminals in cluster for terminal info */
...
//#define MAX_PAGE_NO             9           /* Max Number of Menu Shift Page */
#define MAX_PAGE_NO             11           /* Max Number of Menu Shift Page *///JHH 12-2-03
#define MAX_SET_MENU            20          /* Max Number of Set Menu */
#define MAX_TONE_VOL            3           /* Max Tone Volume */
#define MAX_TERMINAL_NO         16          /* Max Number of Terminal */
...
#define ODD_MDC_BIT0            0x01    /* MDC Odd Address Bit 0 */
#define ODD_MDC_BIT1            0x02    /* MDC Odd Address Bit 1 */
#define ODD_MDC_BIT2            0x04    /* MDC Odd Address Bit 2 */
#define ODD_MDC_BIT3            0x08    /* MDC Odd Address Bit 3 */
#define EVEN_MDC_BIT0           0x10    /* MDC even Address Bit 0 */
#define EVEN_MDC_BIT1           0x20    /* MDC even Address Bit 1 */
#define EVEN_MDC_BIT2           0x40    /* MDC even Address Bit 2 */
#define EVEN_MDC_BIT3           0x80    /* MDC even Address Bit 3 */
...
#define AC_STORE_FORWARD		102			/* STORE AND FORWARD CONTROL */
...
#define AC_COLOR_PALETTE		209			/* SET COLOR PALETTE	*/
...
#define MDC_DEPT2_ADR         28     /* Department & PLU #2 */
#define MDC_SCALE_ADR         29     /* Scale */
#define MDC_VALIDATION_ADR    30     /* 1 line validation */
...
#define MDC_TEND11_ADR        63     /* Tender #1 */
#define MDC_TEND12_ADR        64     /* Tender #1 */
#define MDC_TEND21_ADR        65     /* Tender #2 */
#define MDC_TEND22_ADR        66     /* Tender #2 */
#define MDC_TEND31_ADR        67     /* Tender #3 */
#define MDC_TEND32_ADR        68     /* Tender #3 */
#define MDC_TEND41_ADR        69     /* Tender #4 */
#define MDC_TEND42_ADR        70     /* Tender #4 */
#define MDC_TEND51_ADR        71     /* Tender #5 */
#define MDC_TEND52_ADR        72     /* Tender #5 */
#define MDC_TEND61_ADR        73     /* Tender #6 */
#define MDC_TEND62_ADR        74     /* Tender #6 */
#define MDC_TEND71_ADR        75     /* Tender #7 */
#define MDC_TEND72_ADR        76     /* Tender #7 */
#define MDC_TEND81_ADR        77     /* Tender #8 */
#define MDC_TEND82_ADR        78     /* Tender #8 */
...
#define MDC_SUPER_ADR         85     /* Supervisor Sign-In & Resettable/Non-Resettable Control */
...
#define MDC_CPPARA2_ADR      100     /* Charge Posting Parameter #2 */
...
#define MDC_CPTEND1_ADR       180     /* Tender #1 for charge posting */
#define MDC_CPTEND2_ADR       181     /* Tender #2 for charge posting */
#define MDC_CPTEND3_ADR       182     /* Tender #3 for charge posting */
#define MDC_CPTEND4_ADR       183     /* Tender #4 for charge posting */
#define MDC_CPTEND5_ADR       184     /* Tender #5 for charge posting */
#define MDC_CPTEND6_ADR       185     /* Tender #6 for charge posting */
#define MDC_CPTEND7_ADR       186     /* Tender #7 for charge posting */
#define MDC_CPTEND8_ADR       187     /* Tender #8 for charge posting */
#define MDC_CPTEND9_ADR       188     /* Tender #9 for charge posting */
#define MDC_CPTEND10_ADR      189     /* Tender #10 for charge posting */
#define MDC_CPTEND11_ADR      190     /* Tender #11 for charge posting */
#define MDC_TEND91_ADR        191     /* Tender #9 */
#define MDC_TEND92_ADR        192     /* Tender #9 */
#define MDC_TEND101_ADR       193     /* Tender #10 */
#define MDC_TEND102_ADR       194     /* Tender #10 */
#define MDC_TEND111_ADR       195     /* Tender #11 */
#define MDC_TEND112_ADR       196     /* Tender #11 */
...
#define MDC_TEND13_ADR        201     /* Tender #1 - 3rd address            */
#define MDC_TEND14_ADR        202     /* Tender #1 - 4th address            */
#define MDC_TEND23_ADR        203     /* Tender #2 - 3rd address            */
#define MDC_TEND24_ADR        204     /* Tender #2 - 4th address            */
#define MDC_TEND33_ADR        205     /* Tender #3 - 3rd address            */
#define MDC_TEND34_ADR        206     /* Tender #3 - 4th address            */
#define MDC_TEND43_ADR        207     /* Tender #4 - 3rd address            */
#define MDC_TEND44_ADR        208     /* Tender #4 - 4th address            */
#define MDC_TEND53_ADR        209     /* Tender #5 - 3rd address            */
#define MDC_TEND54_ADR        210     /* Tender #5 - 4th address            */
#define MDC_TEND63_ADR        211     /* Tender #6 - 3rd address            */
#define MDC_TEND64_ADR        212     /* Tender #6 - 4th address            */
#define MDC_TEND73_ADR        213     /* Tender #7 - 3rd address            */
#define MDC_TEND74_ADR        214     /* Tender #7 - 4th address            */
#define MDC_TEND83_ADR        215     /* Tender #8 - 3rd address            */
#define MDC_TEND84_ADR        216     /* Tender #8 - 4th address            */
#define MDC_TEND93_ADR        217     /* Tender #9 - 3rd address            */
#define MDC_TEND94_ADR        218     /* Tender #9 - 4th address            */
#define MDC_TEND103_ADR       219     /* Tender #10 - 3rd address           */
#define MDC_TEND104_ADR       220     /* Tender #10 - 4th address           */
#define MDC_TEND113_ADR       221     /* Tender #11 - 3rd address           */
#define MDC_TEND114_ADR       222     /* Tender #11 - 4th address           */
#define MDC_DISPLAY_ADR       231     /* LCD Display                 R3.0   */
#define MDC_PRINTPRI_ADR      232     /* Print Priority              R3.0   */
#define MDC_COMBCOUPON_ADR    233     /* Combination Coupon          R3.0   */
#define MDC_TRANNUM_ADR       234     /* Unique Trans#               R3.0   */
#define MDC_DEPT3_ADR         235     /* Department & PLU #3         R3.1   */
...
#define MDC_STR_FWRD_ADR	 276	  //Store and forward
...
#define MDC_SYSTEM1_ADR      365     /* system mdc, 2172 */
#define MDC_SYSTEM2_ADR      366     /* system mdc, 2172 */
#define MDC_SYSTEM3_ADR      367     /* system mdc, 2172 */
#define MDC_SYSTEM4_ADR      368     /* system mdc, 2172 */
...
#define MDC_ACCTSECURITY_ADR	377	//Account Security SR#131
#define MDC_ACCTMASKING_ADR		378 //Account Digit Masking SR#131

#define MDC_CHECK_NO_PURCHASE	379 //Check Cash no Purchase SR#18
...
#define MDC_HALOOVR_ADR		 384	//SR 143 HALO Override Key

#define MDC_TEND1201_ADR	 385   //Tender 12 1st Address
#define MDC_TEND1202_ADR	 386   //Tender 12 2nd Address
#define MDC_TEND1301_ADR	 387   //Tender 13 1st Address
#define MDC_TEND1302_ADR	 388   //Tender 13 2nd Address
#define MDC_TEND1401_ADR	 389   //Tender 14 1st Address
#define MDC_TEND1402_ADR	 390   //Tender 14 2nd Address
#define MDC_TEND1501_ADR	 391   //Tender 15 1st Address
#define MDC_TEND1502_ADR	 392   //Tender 15 2nd Address
#define MDC_TEND1601_ADR	 393   //Tender 16 1st Address
#define MDC_TEND1602_ADR	 394   //Tender 16 2nd Address
#define MDC_TEND1701_ADR	 395   //Tender 17 1st Address
#define MDC_TEND1702_ADR	 396   //Tender 17 2nd Address
#define MDC_TEND1801_ADR	 397   //Tender 18 1st Address
#define MDC_TEND1802_ADR	 398   //Tender 18 2nd Address
#define MDC_TEND1901_ADR	 399   //Tender 19 1st Address
#define MDC_TEND1902_ADR	 400   //Tender 19 2nd Address
#define MDC_TEND2001_ADR	 401   //Tender 20 1st Address
#define MDC_TEND2002_ADR	 402   //Tender 20 2nd Address


#define MDC_CPTEND12_ADR	 403   //Tender 12 CP Address
#define MDC_CPTEND13_ADR	 404   //Tender 13 CP Address
#define MDC_CPTEND14_ADR	 405   //Tender 14 CP Address
#define MDC_CPTEND15_ADR	 406   //Tender 15 CP Address
#define MDC_CPTEND16_ADR	 407   //Tender 16 CP Address
#define MDC_CPTEND17_ADR	 408   //Tender 17 CP Address
#define MDC_CPTEND18_ADR	 409   //Tender 18 CP Address
#define MDC_CPTEND19_ADR	 410   //Tender 19 CP Address
#define MDC_CPTEND20_ADR	 411   //Tender 20 CP Address


#define MDC_TEDN1203_ADR	 412   //Tender 12 3rd Address
#define MDC_TEND1204_ADR	 413   //Tender 12 4th Address
#define MDC_TEND1303_ADR	 414   //Tender 13 3rd Address
#define MDC_TEND1304_ADR	 415   //Tender 13 4th Address
#define MDC_TEND1403_ADR	 416   //Tender 14 3rd Address
#define MDC_TEND1404_ADR	 417   //Tender 14 4th Address
#define MDC_TEND1503_ADR	 418   //Tender 15 3rd Address
#define MDC_TEND1504_ADR	 419   //Tender 15 4th Address
#define MDC_TEND1603_ADR	 420   //Tender 16 3rd Address
#define MDC_TEND1604_ADR	 421   //Tender 16 4th Address
#define MDC_TEND1703_ADR	 422   //Tender 17 3rd Address
#define MDC_TEND1704_ADR	 423   //Tender 17 4th Address
#define MDC_TEND1803_ADR	 424   //Tender 18 3rd Address
#define MDC_TEND1804_ADR	 425   //Tender 18 4th Address
#define MDC_TEND1903_ADR	 426   //Tender 19 3rd Address
#define MDC_TEND1904_ADR	 427   //Tender 19 4th Address
#define MDC_TEND2003_ADR	 428   //Tender 20 3rd Address
#define MDC_TEND2004_ADR	 429   //Tender 20 4th Address
...
#define MDC_RPTCAS39_ADR     438   //Operator Report (added for new Tenders)
#define MDC_RPTCAS40_ADR	 439   //Operator Report (added for new Tenders)
...
#define MDC_RPTCAS49_ADR	 466	//Operator Reports (for bonus totals)
...
#define MDC_RPTFIN45_ADR	 470	//Financial Reports (for bonus totals)
...
#define MDC_TEND15_ADR        483     /* Tender #1 - 5th address            */
#define MDC_TEND25_ADR        484     /* Tender #2 - 5th address            */
#define MDC_TEND35_ADR        485     /* Tender #3 - 5th address            */
#define MDC_TEND45_ADR        486     /* Tender #4 - 5th address            */
#define MDC_TEND55_ADR        487     /* Tender #5 - 5th address            */
#define MDC_TEND65_ADR        488     /* Tender #6 - 5th address            */
#define MDC_TEND75_ADR        489     /* Tender #7 - 5th address            */
#define MDC_TEND85_ADR        490     /* Tender #8 - 5th address            */
#define MDC_TEND95_ADR        491     /* Tender #9 - 5th address            */
#define MDC_TEND105_ADR       492     /* Tender #10 - 5th address           */
#define MDC_TEND115_ADR       493     /* Tender #11 - 5th address           */
#define MDC_TEND1205_ADR	  494     //Tender 12 5th Address
#define MDC_TEND1305_ADR	  495     //Tender 13 5th Address
#define MDC_TEND1405_ADR	  496     //Tender 14 5th Address
#define MDC_TEND1505_ADR	  497     //Tender 15 5th Address
#define MDC_TEND1605_ADR	  498     //Tender 16 5th Address
#define MDC_TEND1705_ADR	  499     //Tender 17 5th Address
#define MDC_TEND1805_ADR	  500     //Tender 18 5th Address
#define MDC_TEND1905_ADR	  501     //Tender 19 5th Address
#define MDC_TEND2005_ADR	  502     //Tender 20 5th Address
...
#define MDC_PAUSE_1_2_ADR     515     /* Numeric Pause Key #1 and #2 settings */
#define MDC_PAUSE_3_4_ADR     516     /* Numeric Pause Key #3 and #4 settings */
...
#define MDC_RPTCAS50_ADR      521     /* Operator Report for returns, Amtrak/VCS */
...
#define MDC_ADR_MAX           600    /* Max Address */
...
#define FLEX_WT_ADR             3    /* Number of Waiter */
#define FLEX_CAS_ADR            4    /* Number of Cashier */
#define FLEX_EJ_ADR             5    /* Size of EJ File */
#define FLEX_ETK_ADR            6    /* Number of ETK File */
#define FLEX_ITEMSTORAGE_ADR    7    /* Number of Item for Item Storage */
#define FLEX_CONSSTORAGE_ADR    8    /* Number of Item for Cons. Storage */
#define FLEX_GC_ADR             9    /* Number of GuestCheck */
...
#define FLEX_MLD_ADR           14	/* Mld File Size, V3.3 */
#define FLEX_FPDB_ADR		   15	//Number of the Fingerprint database

/* Warning !!! You have to change this Define When Above Max. address is changed */
/* except MLD Mnemonics file, because hiden data at Prog.#2, V3.3 */
#define FLEX_ADR_MAX           FLEX_PPI_ADR /* Max Address */

#define FLEX_PRECHK_BUFFER      0    /* pre-check buffering print */
#define FLEX_PRECHK_UNBUFFER    1    /* pre-check unbuffering print */
#define FLEX_POST_CHK           2    /* post check buffering printprint */
#define FLEX_STORE_RECALL       3    /* store/ recall buffering print system */

/*---- Define the number of Record ----*/

#define FLEX_DEPT_MAX         250               /* 2172 */
#define FLEX_PLU_MAX       500000L              /* 2172 */
#define FLEX_WT_MAX           100
#define FLEX_CAS_MAX          300       /* V3.3 */
#define FLEX_ETK_MAX          250
#define FLEX_GC_MAX          5000	//800 JHHJ Guestcheck Change 800->5000 3-15-04
#define FLEX_EJ_MAX          12000
#define FLEX_ITEMSTORAGE_MAX  200
#define FLEX_CPN_MAX          255	//TEMPSAVE 100 JHHJ Database Changes, Coupon Change 100-> 300 3-14-04
#define FLEX_CSTRING_MAX     8000
#define FLEX_PROGRPT_MAX       64
#define FLEX_PPI_MAX          255	//ESMITH -- **edited from 300 to 255 - PDINU


/*#define FLEX_MLD_MAX          200       /* V3.3 */
#define FLEX_MLD_MAX          220       /* saratoga */
#define	FLEX_P2_MIN				0		/* ESMITH Minimum value allowed for values in p2 other than transaction and guest check*/
...
#define FSC_MIN_PAGE           1      /* Page 1 */
#define FSC_MAX_PAGE           9      /* Page 5 */

/*------------------------------------------------------------------------*\
*   Define - FSC for Regular Keyboard Address (PRG #3)
\*------------------------------------------------------------------------*/

#define FSC_MIN_ADR           1      /* Address 1 */
#define FSC_MAX_ADR         165      /* Address 165 */

#define FSC_MICRO_ADR       165     /* Micromotion Keyboard Max Address */
#define FSC_CONV_ADR         68     /* Conventional Keyboard Max Address */
...
#define FSC_MAJOR_MAX        86     /* Max Number of Major FSC Data, 2172 */

/*------------------------------------------------------------------------*\
*   Define - Minor FSC Max Data (PRG #3)
\*------------------------------------------------------------------------*/

#define FSC_MINOR_MAX        11      /* Minor FSC Data Max */

#define FSC_PLU_MICROMAX	165		/*JHHJ for use with keyboard layouts*/
#define FSC_PLU_MAX         300      /* Keyed PLU for Micromotion,  R3.1 */
#define FSC_PLU_CONVMAX      68      /* Keyed PLU Key for Conventional Keyboard */
#if defined(POSSIBLE_DEAD_CODE)
		// This code is a candidate for removal with the next release of source code
#define FSC_DEPT_MAX        300/*165*/      /* Keyed Department Key, 2172 */
#define FSC_DEPT_CONVMAX      68      /* Keyed PLU Key for Conventional Keyboard, 2172 */
#endif

#define FSC_DEPT_MAX         50      /* Keyed Department Key, 2172 */
#define FSC_DEPT_CONVMAX     50      /* Keyed PLU Key for Conventional Keyboard, 2172 */
#define FSC_PM_MAX            8      /* Print Modifier Key */
#define FSC_ADJ_MAX          20      /* Adjective Key */
#define FSC_TEND_MAX         STD_TENDER_MAX      /* Tender Key *//* JHHJ 3-16-04 Tender 11->20*/
#define FSC_FC_MAX            8      /* Foreign Currency Key, 2172 */

/*#define FSC_TOTAL_MAX         8      /* Total Key */
#define FSC_TOTAL_MAX         STD_TOTAL_MAX      /* Total Key */

#define FSC_ADDCHK_MAX        3      /* Add Check Key */
#define FSC_IDISC_MAX         2      /* Item Discount Key */
#define FSC_RDISC_MAX         6      /* Regular Discount Key,     R3.1 */
#define FSC_TAXMD_MAX        11      /* Tax Modifier Key */
#define FSC_PRTDMD_MAX        3      /* Print on Demand Key */
#define FSC_PREAMT_MAX        4      /* Preset Cash Amount Key */
#define FSC_DMSFT_MAX         9      /* Direct Menu Shift Key,    R3.1 */
#define FSC_CPN_MAX         100      /* Coupon Key */
#define FSC_STRING_MAX      200      /* String Key */
#define FSC_SEAT_MAX          2      /* Seat No. Key,             R3.1 */
...
#define MAX_SREGNO              9999999L    /* Max store/ reg No. */
...
#define SPNO_ADR_MAX            8    /* Max Address */
...
#define ACSC_COLORPAL_ADR	  209	 /* Set Color Palette */

#define ACSC_TBL_END          0xFFFF   /* Table End */

/* Warning !!! You have to change this Define When Above Max. address is changed */

#define ACSC_ADR_MAX          233    /* Max Address */

/*------------------------------------------------------------------------*\
*   Define - Transaction HALO Address (PRG # 10)
\*------------------------------------------------------------------------*/

#define HALO_TEND1_ADR          1    /* Tender #1 */
...
#define HALO_RDISC1_ADR        13    /* Regular Discount #1 */
...
#define HALO_FOREIGN1_ADR      19    /* Foreign Currency 1 */
...
#define HALO_ADR_MAX           50    /* Max Address, MAX_HALOKEY_NO */
...
#define SLIP_EXTRADOT_ADR       3    /* # of extra dot Line for Slip Printer */
...
#define SLIP_ADR_MAX            6    /* Max Address */
...
/*------------------------------------------------------------------------*\
*   Define - Transaction Mnemonics Address (PRG #20)
\*------------------------------------------------------------------------*/
...
#define TRN_TTL1_ADR           42        /* Total #1 */
#define TRN_TTL2_ADR           43        /* Total #2 */
#define TRN_TTL3_ADR           44        /* Total #3 */
#define TRN_TTL4_ADR           45        /* Total #4 */
#define TRN_TTL5_ADR           46        /* Total #5 */
#define TRN_TTL6_ADR           47        /* Total #6 */
#define TRN_TTL7_ADR           48        /* Total #7 */
#define TRN_TTL8_ADR           49        /* Total #8 */
...
#define TRN_POST_ADR          114        /* Post receipt */
...
#define TRN_CONTINUE_ADR      137        /* Continue Message, V3.3 */
...
#define TRN_TTL9_ADR          159        /* Total #9 */
...
#define TRN_FOR_ADR			  166		 /* @/For functionality SR*/
#define TRN_HALO_ADR		  167		 /* HALO Override functionality */
#define TRN_PCKUP_REQ		  168		 /* Cash Drawer Limit functionality */
...
#define TRN_TOTAL10_ADR		  178		 /* Total 10 */
#define TRN_TOTAL11_ADR		  179		 /* Total 10 */
#define TRN_TOTAL12_ADR		  180		 /* Total 10 */
#define TRN_TOTAL13_ADR		  181		 /* Total 10 */
#define TRN_TOTAL14_ADR		  182		 /* Total 10 */
#define TRN_TOTAL15_ADR		  183		 /* Total 10 */
#define TRN_TOTAL16_ADR		  184		 /* Total 10 */
#define TRN_TOTAL17_ADR		  185		 /* Total 10 */
#define TRN_TOTAL18_ADR		  186		 /* Total 10 */
#define TRN_TOTAL19_ADR		  187		 /* Total 10 */
#define TRN_TOTAL20_ADR		  188		 /* Total 10 */
#define	TRN_PRICE_ADR		  189		 /* PRICE	 */ //SR281
#define TRN_NONE_DONE_ADR	  190		// Mnemonic for NONE/DONE on OEP window JHHJ
#define TRN_BACK_OEP_ADR	  191		// Mnemonic for BACK on OEP window JHHJ
#define TRN_ITEMCOUNT_ADR	  192		//  Item Count Summary SR217 JHHJ
#define TRN_MERC_CPY_ADR	  193		// Merchant Copy for receipt EPT
#define TRN_CUST_CPY_ADR	  194		// Customer Copy for receipt EPT
#define TRN_TIP_LINE_ADR	  195		// Tip Line for receipt EPT
#define TRN_TTL_LINE_ADR	  196		// Total Line for receipt EPT
#define TRN_GIFT_RECEIPT_ADR  197		// Gift Receipt for receipt JHH
...
#define TRN_ORDER_DEC_OFFSET  301       // add order declaration fsc to this value to get mnemonic
...
/*------------------------------------------------------------------------*\
*   Define - Lead Through Mnemonics Address (PRG # 21)
\*------------------------------------------------------------------------*/
...
#define LDT_LNKDWN_ADR          6       /* Link Down */
...
#define LDT_PAUSEMSG1_ADR      88       /* Control String Table -- Pause Message #1 */
#define LDT_PAUSEMSG2_ADR      89       /* Control String Table -- Pause Message #2 */
#define LDT_PAUSEMSG3_ADR      90       /* Control String Table -- Pause Message #3 */
#define LDT_PAUSEMSG4_ADR      91       /* Control String Table -- Pause Message #4 */
#define LDT_PAUSEMSG5_ADR      92       /* Control String Table -- Pause Message #5 */
...
//Additional alpha and numeric pause messages (5 each) added for US Customs SCER cwunn 3/19/2003
#define LDT_PAUSEMSG11_ADR    130       /* Control String Table -- Pause Message #11 */
#define LDT_PAUSEMSG12_ADR    131      /* Control String Table -- Pause Message #12  */
#define LDT_PAUSEMSG13_ADR    132       /* Control String Table -- Pause Message #13 */
#define LDT_PAUSEMSG14_ADR    133       /* Control String Table -- Pause Message #14 */
#define LDT_PAUSEMSG15_ADR    134       /* Control String Table -- Pause Message #15 */
...
#define LDT_PAUSEMSG20_ADR    139       /* Control String Table -- Pause Message #20 for Alpha */
...
#define LDT_ADR_MAX         MAX_LEAD_NO      /* Max Address */

/*------------------------------------------------------------------------*\
*   Define - Report Name Address (PRG #22)

	see ParaReportName in UNINIRAM UNINT Para.
\*------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------*\
*   Define - Special Mnemonics Address (PRG #23)

	see ParaSpeMnemo in UNINIRAM UNINT Para.
\*------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------*\
*   Define - Adjective Mnemonics Address (PRG # 46)
\*------------------------------------------------------------------------*/
...
#define ADJ_ADR_MAX            20        /* Max Address */
...
#define PM_ADR_MAX              8        /* Max Address */
...
/*#define MDPT_ADR_MAX           10      */  /* Max Address */
#define MDPT_ADR_MAX           30        /* Max Address */
...
#define AAKTN_ADR_MAX           8       /* Max. Number of This Address */
...
#define SHR_ADR_MAX            48       /* Max. Number of This Address */
...
#define HOTEL_APVL_CODE_ADR   15         /* Approval Code       */

/* Warning !!! You have to change this Define When Above Max. address is changed */

#define HOTELID_ADR_MAX       15          /* HOTEL ID MAX ADDRESS */

/*------------------------------------------------------------------------*\
*   Define - 24 Character Mnemonics Address (PRG #57)
\*------------------------------------------------------------------------*/
...
#define TLTY_ADR_MAX            6        /* Max Address */
...
#define TLCT_ADR_MAX            9        /* Max Address */
...
#define TENDERKEY_TRANTYPE_CHARGE    4    // Tender key generates a Charge transaction type for Charge Post
...
// These defines are for accessing on/off single bit values stored in ulFlags1 of a TENDERKEYINFO struct
...
// Notice requires a point so if using a non-pointer use the addressof operator (&).
...
#define TLCT_NO1_FLD            1        /* Field #1 */

/* Warning !!! You have to change this Define When Above Max. address is changed */

#define TLCT_FLD_MAX            12       /* Max Field */
...
#define PLUPG_PAGE1_ADR         1        /* Menu Page 1 */
#define PLUPG_PAGE2_ADR         2        /* Menu Page 2 */
#define PLUPG_PAGE3_ADR         3        /* Menu Page 3 */
#define PLUPG_PAGE4_ADR         4        /* Menu Page 4 */
#define PLUPG_PAGE5_ADR         5        /* Menu Page 5 */
#define PLUPG_PAGE6_ADR         6        /* Menu Page 6 */
#define PLUPG_PAGE7_ADR         7        /* Menu Page 7 */
#define PLUPG_PAGE8_ADR         8        /* Menu Page 8 */
#define PLUPG_PAGE9_ADR         9        /* Menu Page 9 */
#define PLUPG_PAGE10_ADR		10		 /* Menu Page 10*/
#define PLUPG_PAGE11_ADR		11		 /* Menu Page 11*/

/* Warning !!! You have to change this Define When Above Max. address is changed */

#define PLUPG_ADR_MAX           11        /* Max Address */
...
#define CTLPG_PAGE10_ADR       11		 /* Menu Page 10 for touch screen jhh 12-02-03*/
#define CTLPG_PAGE11_ADR	   12		 /* Menu Page 11 for touch screen jhh 12-02-03*/
...
#define CTLPG_ADJ_PAGE10_ADR   22		 /* Adjective Menu Page 11 for touch screen jhh 12-02-03*/
#define CTLPG_ADJ_PAGE11_ADR   23		 /* Adjective Menu Page 11 for touch screen jhh 12-02-03*/
...
#define ASN_AKEY_ADR            1        /* Cashier A Key */
#define ASN_BKEY_ADR            2        /* Cashier B Key */
...
#define PPI_ADR_MAX            20        /* Max Address */
...
#define RND_ITEMDISC2_ADR       2        /* Item Discount #2 */
#define RND_REGDISC1_ADR        3        /* Regular Discount #1 */
#define RND_REGDISC2_ADR        4        /* Regular Discount #2 */
#define RND_CHGTIP1_ADR         5        /* Charge Tips/Service #1 */
#define RND_CHGTIP2_ADR         6        /* Charge Tips/Service #2 */
#define RND_TAX1_ADR            7        /* Tax #1 */
#define RND_TAX2_ADR            8        /* Tax #2 */
#define RND_FOREIGN1_1_ADR      9        /* Foreign Currency Rate #1_1 */
#define RND_FOREIGN1_2_ADR     10        /* Foreign Currency Rate #1_2 */
#define RND_FOREIGN2_1_ADR     11        /* Foreign Currency Rate #2_1 */
#define RND_FOREIGN2_2_ADR     12        /* Foreign Currency Rate #2_2 */
#define RND_FOREIGN3_1_ADR     13        /* Foreign Currency Rate #3_1, 2172 */
#define RND_FOREIGN3_2_ADR     14        /* Foreign Currency Rate #3_2, 2172 */
#define RND_FOREIGN4_1_ADR     15        /* Foreign Currency Rate #4_1, 2172 */
#define RND_FOREIGN4_2_ADR     16        /* Foreign Currency Rate #4_2, 2172 */
#define RND_FOREIGN5_1_ADR     17        /* Foreign Currency Rate #5_1, 2172 */
#define RND_FOREIGN5_2_ADR     18        /* Foreign Currency Rate #5_2, 2172 */
#define RND_FOREIGN6_1_ADR     19        /* Foreign Currency Rate #6_1, 2172 */
#define RND_FOREIGN6_2_ADR     20        /* Foreign Currency Rate #6_2, 2172 */
#define RND_FOREIGN7_1_ADR     21        /* Foreign Currency Rate #7_1, 2172 */
#define RND_FOREIGN7_2_ADR     22        /* Foreign Currency Rate #7_2, 2172 */
#define RND_FOREIGN8_1_ADR     23        /* Foreign Currency Rate #8_1, 2172 */
#define RND_FOREIGN8_2_ADR     24        /* Foreign Currency Rate #8_2, 2172 */
#define RND_TOTAL1_ADR         25        /* Local Currency/Total #1     2172 */
#define RND_TOTAL2_ADR         26        /* Local Currency/Total #2     2172 */
...
/*#define RND_ADR_MAX            24      */ /* Max Address */
#define RND_ADR_MAX            30        /* Max Address */
...
#define RATE_ADR_MAX            20        /* Max Address */
...
#define SOFTCHK_ADR_MAX      10        /* max address */
...
#define CNV_ADR_MAX              8        /* Max Address */

/*------------------------------------------------------------------------*\
*   Define - Set Tare Table Address (A/C 111)
\*------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------*\
*   Define - Set Misc Parameter Address (A/C 128) ### ADD Saratoga (051900)
*------------------------------------------------------------------------*/
...
#define MISC_ADR_MAX            MAX_MISC_SIZE        /* Max Address */
...
#define LABOR_COST99_ADR       99        /* Labor Cost Value #99 */
#define LABOR_COST100_ADR     100        /* Labor Cost Value #100 */

/* Warning !!! You have to change this Define When Above Max. address is changed */

#define LABORCOST_ADR_MAX     100        /* Max Address */
...
#define KDS_IP2_ADR             2        /* KDS IP Address #2 */
#define KDS_IP3_ADR             3        /* KDS IP Address #3 */
#define KDS_IP4_ADR             4        /* KDS IP Address #4 */
#define KDS_PORT1_ADR           5        /* KDS IP Address #5 */
#define KDS_PORT2_ADR           6        /* KDS IP Address #6 */
#define KDS_PORT3_ADR           7        /* KDS IP Address #7 */
#define KDS_PORT4_ADR           8        /* KDS IP Address #7 */

/* Warning !!! You have to change this Define When Above Max. address is changed */

#define KDS_IP_ADR_MAX          4        /* Max Address *//* ### MOD Saratoga (3 -> 4)(051900) */
/*#define KDS_ADR_MAX             6      */  /* Max Address */
#define KDS_ADR_MAX             8        /* Max Address */
...
#define DEPTPG_PAGE10_ADR         10        /* Menu Page 10 */
#define DEPTPG_PAGE11_ADR         11        /* Menu Page 11 */
...
#define PARA_CPN_LEN            STD_CPNNAME_LEN       /* Para Combination Coupon */

#define PARA_PROMOTION_LEN      24       /* ParaPromotion */
#define PARA_TRANSMNEMO_LEN     20       /* ParaTransMnemo JHHJ Database Changes*/
#define PARA_LEADTHRU_LEN       20       /* ParaLeadThru Database Changes JHHJ*/
#define PARA_REPORTNAME_LEN      6       /* ParaReportName */
#define PARA_SPEMNEMO_LEN        4       /* ParaSpeMnemo */
#define PARA_ADJMNEMO_LEN        4       /* ParaAdjMnemo */
#define PARA_PRTMODI_LEN        10       /* ParaPrtModi */
#define PARA_MAJORDEPT_LEN      20       /* ParaMajorDEPT */
#define PARA_CHAR24_LEN         24       /* ParaChar24 */


/* #define PARA_CHAR44_LEN      44  */     /* ParaChar44 */
#define PARA_SOFTCHK_LEN        42       /* ParaSoftCheck */
#define PARA_CASHIER_LEN        20       /*             *//* V3.3 */
#define PARA_WAITER_LEN         10       /*             */
...
#define PLU_TYPE_MASK         PLU_ADJ_TYP /* One Adjective */
...
/* PLU Record Address 3,4 */

#define PLU_MINUS               0x01    /* Minus */
#define PLU_SPECIAL             0x02    /* Special */
#define PLU_REQ_SUPINT          0x04    /* Request Supervisor Intervention */
#define PLU_COMP_MODKEY         0x08    /* Compulsory Print Modifier Key */
#define PLU_COMP_CODKEY         0x10    /* Compulsory Print Modifier or Condiment Key */
...
/* PLU Record Address 5,6 */

#define PLU_AFFECT_TAX1         0x01    /* Affect Taxable Itemizer #1 */
#define PLU_AFFECT_TAX2         0x02    /* Affect Taxable Itemizer #2 */
#define PLU_AFFECT_TAX3         0x04    /* Affect Taxable Itemizer #3 */
#define PLU_AFFECT_FS           0x08    /* Affect Food Stamp Itemizer */
#define PLU_AFFECT_DISC1        0x40    /* Affect Discountable Itemizer #1 */
#define PLU_AFFECT_DISC2        0x80    /* Affect Discountable Itemizer #2 */

/* PLU Record Address 7,8 */

#define PLU_SCALABLE            0x01    /* Scalable PLU */
#define PLU_CONDIMENT           0x02    /* Condiment */
#define PLU_HASH                0x04    /* Hash PLU */
...
//
// See as well function MaintPLUEdit() in GenPOS which allows the bonus total for a PLU to be edited.
// See places in GenPOS where define PLU_FIELD9_ADR is used with the display of PLU data.
...
/*------------------------------------------------------------------------*\
*   PARAMETER - FLEXIBLE DRIVE THROUGH/MULTI STORE RECALL DEFINE
\*------------------------------------------------------------------------*/
...
#define LCD_RPT_DAILY_ADR      74       /* Daily Report Common */
#define LCD_RPT_PDT_ADR        75       /* PTD Report Common */
...
/*#define LCD_PLU_ADDR19_ADR    122*/       /* AC 63, Address 19 */
/*#define LCD_PLU_ADDR20_ADR    123*/       /* AC 63, Address 20 */
/*#define LCD_PLU_ADDR21_ADR    124*/       /* AC 63, Address 21 */
/*#define LCD_PLU_ADDR22_ADR    125*/       /* AC 63, Address 22 */
/*#define LCD_PLU_ADDR23_ADR    126*/       /* AC 63, Address 23 */
/*#define LCD_PLU_ADDR_23_ADR    122       /* AC 63, Address 19, 2172 */
/*#define LCD_PLU_ADDR_24_ADR    123       /* AC 63, Address 20, 2172 */
/*#define LCD_PLU_ADDR_25_ADR    124       /* AC 63, Address 21, 2172 */
/*#define LCD_PLU_ADDR_26_ADR    125       /* AC 63, Address 22, 2172 */
/*#define LCD_PLU_ADDR_27_ADR    126       /* AC 63, Address 23, 2172 */
...
/*#define LCD_AC113_ADR         195     */  /* AC 113, 2172 */
...
/*#define LCD_PLU_ADDR22_ADR    198       /* AC 63, Address 22, 2172 */
/*#define LCD_DPT_ADDR14_ADR    199       /* AC 114, Address 14, 2172 */
/*#define LCD_PG51_ADR          200       /* PG 65, 2172 */
/*#define LCD_PG51_ADR          196     */  /* PG 65, 2172 */
...
/* Warning !!! You have to change this Define When Above Max. address is changed */
#define LCD_ADR_MAX           240       /* Max Address NCR2172*/


#define FILE_LEN_ID 10 //moved from Filel.h to here because we now use this same size in UNINIRAM

#define PEPLOGPATH			  WIDE("Peplog.log")
