...
typedef union _ITEMNO {                     /* format by item number only   */
    UCHAR   aucPluNumber[7];                    /* item number of PLU       */
    UCHAR   uchMixNumber;                       /* item number of mix-match */
    UCHAR   uchPpiNumber;                       /* item number of PPI       */
} ITEMNO, *PITEMNO;

/*==========================================================================*\
;+                                                                          +
...
USHORT PLUAPI PluCreateFile(USHORT, USHORT);    /* create a file            */
...
USHORT PLUAPI PluReportMainte(USHORT, VOID *, USHORT *, USHORT *);
USHORT PLUAPI PluRemoveMainte(USHORT, USHORT);  /* remove mainte. records   */
                                                /* modify mainte. records   */
USHORT PLUAPI PluModifyMainte(USHORT, USHORT, VOID *);
                                                /* read mainte. records     */
USHORT PLUAPI PluReadMainte(USHORT, USHORT, VOID *, USHORT *);
                                                /* add mainte. records      */
USHORT PLUAPI PluAddMainte(USHORT, VOID *, USHORT *);
