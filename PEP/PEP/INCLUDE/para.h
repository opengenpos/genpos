...
typedef struct  {
        ...
        WCHAR  aszPLUNumber[PLU_MAX_DIGIT+1]; /* PLU Number */
}PLUNO;
...
typedef struct  {
        ...
        WCHAR  auchCPNTarget[MAX_CPNTARGET_SIZE][PLU_MAX_DIGIT];   /* PLU Number (packed BCD data), 2172 */
...
typedef struct  {
        ...
        WCHAR  aucPLUNumber[PLU_MAX_DIGIT+1+1];     /* PLU Number (packed BCD data), 2172 */
        ...
        USHORT usFamilyCode;                        /* Family Code, 05/13/00 *//* ### ADD Saratoga (051900) */
        UCHAR  uchStatus;                           /* 0=with data, 1=without data */
		...
		UCHAR	auchStatus2[MAX_PLUSTS_SIZE];
}PARAPLU;
...
typedef struct {
    ...
    WCHAR  aszInputData[MAX_KDSIP_INPUT_LEN];   /* input buffer */ /* Saratoga */
    UCHAR  uchStatus;                           /* 0=with data, 1=without data */
    USHORT usPrintControl;                      /* Print Control */
}PARAKDSIP;
...
/*--- read/write misc. parameter ---*//* ### ADD Saratoga (051900) */
...
VOID  ParaMiscParaRead( PARAMISCPARA *pData );          /* read misc. parameter */ /* ### ADD Saratoga (051900) */
VOID  ParaMiscParaWrite( PARAMISCPARA *pData );         /* write misc. parameter *//* ### ADD Saratoga (051900) */
