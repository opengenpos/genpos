...
#define PLU_BEFORE_STATUS_LEN		102//RPH 3-18-4 67		
															/* 52 *//* auchPluNumber[13] +
						 									uchAdjective +
															usDeptNumber +
															ulUnitPrice[5] +
...
USHORT PluCreateFile(USHORT, USHORT);    /* create a file            */
...
USHORT PluReportMainte(USHORT, VOID *, USHORT *, USHORT *);
USHORT PluRemoveMainte(USHORT, USHORT);  /* remove mainte. records   */
                                                /* modify mainte. records   */
USHORT PluModifyMainte(USHORT, USHORT, VOID *);
                                                /* read mainte. records     */
USHORT PluReadMainte(USHORT, USHORT, VOID *, USHORT *);
                                                /* add mainte. records      */
USHORT PluAddMainte(USHORT, VOID *, USHORT *);
...
/* --- file access in block unit --- */
                                                /* read from a file         */
USHORT PluReadBlock(USHORT, UCHAR *, USHORT, USHORT *);
                                                /* write to a file          */
USHORT PluWriteBlock(USHORT, UCHAR *, USHORT, USHORT *);
                                                /* change file ptr.         */
USHORT PluSeekBlock(USHORT, LONG, USHORT, ULONG *);

/* --- mirror file functions --- */
                                                /* open a mirror file       */
USHORT PluOpenMirror(UCHAR FAR *, USHORT *);
USHORT PluOpenMirror2(UCHAR FAR *, UCHAR FAR *, USHORT *);
