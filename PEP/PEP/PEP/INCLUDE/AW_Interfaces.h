...
void memcpy_uchar2tchar (TCHAR *tszPluNo, UCHAR *uszPluNo, size_t npieces);
void memcpy_tchar2uchar (UCHAR *uszPluNo, TCHAR *tszPluNo, size_t npieces);
...
int LoadThatMultiByteString (HINSTANCE hInst, UINT uID, LPTSTR lpBuffer, int nBufferMax);
int LoadThatUnicodeString (HINSTANCE hInst, UINT uID, LPWSTR lpBuffer, int nBufferMax);

int LoadFileCaption(HINSTANCE hResourceDll, UINT uID);

LRESULT SendThatMultiByteString (HWND hDlg, int nCtlID, UINT uMsg, WPARAM wParam, LPARAM lParam);
LRESULT SendThatUnicodeString (HWND hDlg, int nCtlID, UINT uMsg, WPARAM wParam, LPARAM lParam);

LRESULT SendMultiByteStringMsg (HWND hDlg, UINT uMsg, WPARAM wParam, LPARAM lParam);
LRESULT SendUnicodeStringMsg (HWND hDlg, UINT uMsg, WPARAM wParam, LPARAM lParam);

LRESULT SendPepDlgItemMsgString (HWND hDlg, UINT uId, UINT uMsg, WPARAM wParam, LPARAM lParam);
...
#define DlgItemSendTextMessage  SendThatUnicodeString//SendThatMultiByteString

#define WindowSendTextMessage  SendUnicodeStringMsg//SendMultiByteStringMsg
